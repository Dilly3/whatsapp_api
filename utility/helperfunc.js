           ...
           if(contacts !== undefined){
            ...
            if(profile1 !== undefined){
                ...
                return new Promise((resolve, reject)=>{
                    if((sender_name !== undefined) && sender_number !== undefined && body1 !== undefined && timestamp1 !== undefined ){
                        resolve({sender_number,sender_name, body1,timestamp1})
                    }
                    else{
                        reject({})
                    }
